package com.devpj.pet_store.view_controller.fragments;
...
import com.devpj.pet_store.adapter.MyPetsAdapter;
import com.devpj.pet_store.module.LoginResponse;
import com.devpj.pet_store.module.Product;
import com.devpj.pet_store.retrofit.APIClient;
import com.devpj.pet_store.retrofit.APIInterface;
import com.devpj.pet_store.view_controller.activities.AdminDashboard;
import com.devpj.pet_store.view_controller.activities.Login;
...
public class AdminHome  extends Fragment implements MyPetsAdapter.onItemClick {
    FloatingActionButton addpet;
     ...
     ImageButton logout;
     CardView neworders,sales,finished;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        neworders=view.findViewById(R.id.cardView7);
        sales=view.findViewById(R.id.cardView6);
        finished=view.findViewById(R.id.finishedOrders);
       ...
       lr=((AdminDashboard) getActivity()).getMyData();
        ...
        Call<com.devpj.pet_store.module.Sales> salesCall=apiInterface.getmysales("Bearer "+lr.getToken());
        salesCall.enqueue(new Callback<com.devpj.pet_store.module.Sales>() {
            @Override
            public void onResponse(Call<com.devpj.pet_store.module.Sales> call, Response<com.devpj.pet_store.module.Sales> response) {
            ...
            @Override
            public void onFailure(Call<com.devpj.pet_store.module.Sales> call, Throwable throwable) {
